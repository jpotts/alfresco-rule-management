...
<#-- JavaScript Dependencies -->
    ...
    <@script src="${url.context}/res/rule-management-share/js/rules-header.js" group="rules"/>
            ...
            <div class="yui-g">
               ...
               <span id="${el}-inheritButtonContainer" class="inherit inherit-${inheritRulesClass}">
                 ...
                 <span id="${el}-actions" class="hidden">
                  ...
                  <button class="new" id="${el}-convertToShared-button" tabindex="0">${msg("button.to-shared")}</button>
                  <span class="hidden">
